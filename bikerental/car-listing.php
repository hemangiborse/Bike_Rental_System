...
<!--Page Header-->
<section class="page-header listing_page" style="background: url(assets/images/bike.jpg) no-repeat;background-size: cover;">
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Bike & Car Listing</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Home</a></li>
        <li>Bike & Car Listing</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Find Your Bike & Car Here. </h5>
          </div>
...
<option value="CNG">CNG</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Search Bike & Car</button>
              </div>
            </form>
          </div>
        </div>
