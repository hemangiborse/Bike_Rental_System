         ...
         <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              ...
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Previous Owner</a></li>
            </ul>
            ...
            <div class="tab-content"> 
              ...
              <div role="tabpanel" class="tab-pane" id="accessories"> 
                ...
                <table>
                  <thead>
                    <tr>
                      <th colspan="2">Previous Owner</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
...
<?php 
$bid=$_SESSION['brndid'];
$sql="SELECT tblvehicles.VehiclesTitle,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.SeatingCapacity,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesBrand=:bid";
$query = $dbh -> prepare($sql);
